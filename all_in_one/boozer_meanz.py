...
from star_lite_design.utils.displacement import FieldLineDistance, FieldLineMeanZ
import yaml
...
for j in range(20):
    ...
    meanz_err = (max([Jfl.max_distance() for Jfl in meanzs])-FIELDLINE_MEANZ_THRESHOLD)/np.abs(FIELDLINE_MEANZ_THRESHOLD)
