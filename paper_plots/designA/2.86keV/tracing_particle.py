...
ntor_sc=boozer_surfaces[0].surface.ntor
mpol_sc=boozer_surfaces[0].surface.mpol
stellsym_sc=boozer_surfaces[0].surface.stellsym
nfp_sc=boozer_surfaces[0].surface.nfp
...
s.x = boozer_surfaces[0].surface.x
